  ...
  site?: Maybe<{
    siteMetadata?: Maybe<
      Pick<SiteSiteMetadata, 'repository'> & {
        contacts?: Maybe<Array<Maybe<Pick<SiteSiteMetadataContacts, 'label' | 'link'>>>>;
      }
    >;
  }>;
};
...
export type Unnamed_4_Query = {
  site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author' | 'language'>> }>;
};
...
export type IndexPageQuery = {
  allMarkdownRemark: {
    group: Array<
      Pick<MarkdownRemarkGroupConnection, 'totalCount'> & { tag: MarkdownRemarkGroupConnection['fieldValue'] }
    >;
    edges: Array<{
      node: Pick<MarkdownRemark, 'excerpt'> & {
        fields?: Maybe<
          Pick<MarkdownRemarkFields, 'slug'> & { readingTime?: Maybe<Pick<MarkdownRemarkFieldsReadingTime, 'minutes'>> }
        >;
...
export type SinglePageQuery = {
  markdownRemark?: Maybe<
    Pick<MarkdownRemark, 'excerpt' | 'html'> & {
      fields?: Maybe<{ readingTime?: Maybe<Pick<MarkdownRemarkFieldsReadingTime, 'minutes'>> }>;
      frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'description' | 'tags' | 'lang'>>;
    }
  >;
};
