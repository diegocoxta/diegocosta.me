...
<Talk
  ...
  urls={[
    ...
    { link: 'https://github.com/ReactSSA/meetup1-web', label: 'Código Fonte Web', type: 'repository' },
    { link: 'https://github.com/ReactSSA/meetup1-app', label: 'Código Fonte Mobile', type: 'repository' },
  ]}
/>
